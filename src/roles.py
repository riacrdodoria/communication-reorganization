...
facilitator), A1-A3 / B1-B3 (team members, fixed roster order; one Team B member joined nine meetings through a
shared team account, mapped to the same role), BOT (transcription-tool line; removed from the canonical transcripts on 2026-09-05).
...
def short(role):
    """Compact label for figures: FACILITATOR -> F, A1 -> A1."""
    return {"FACILITATOR": "F"}.get(role, role)
